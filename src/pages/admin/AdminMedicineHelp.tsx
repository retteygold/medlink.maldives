...
import { listMedicineRequests, updateMedicineRequestStatus } from '../../lib/dataService'
...
const statuses: MedicineRequest['status'][] = ['open', 'in_progress', 'fulfilled', 'cancelled']
